...
{
    public class CompanyProject : EntityBase
    {
        ...
        public CompanyProject(string name, string description, string picture, string pictureAlt, string pictureTitle, string keywords, string metaDescription, string slug)
        {
            Name = name;
